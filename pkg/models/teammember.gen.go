...
func newTeamMember(db *gorm.DB, opts ...gen.DOOption) teamMember {
	...
	_teamMember.ID = field.NewString(tableName, "id")
	_teamMember.Role = field.NewField(tableName, "role")
	_teamMember.UserUID = field.NewString(tableName, "userUid")
	_teamMember.TeamID = field.NewString(tableName, "teamID")
...
func (t *teamMember) updateTableName(table string) *teamMember {
	...
	t.Role = field.NewField(table, "role")
	t.UserUID = field.NewString(table, "userUid")
