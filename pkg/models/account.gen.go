...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.ProviderRefreshToken = field.NewString(tableName, "providerRefreshToken")
	_account.ProviderAccessToken = field.NewString(tableName, "providerAccessToken")
	_account.ProviderScope = field.NewString(tableName, "providerScope")
	_account.LoggedIn = field.NewTime(tableName, "loggedIn")
...
type account struct {
	...
	ProviderRefreshToken field.String
	ProviderAccessToken  field.String
	ProviderScope        field.String
	LoggedIn             field.Time
...
func (a *account) updateTableName(table string) *account {
	...
	a.ProviderRefreshToken = field.NewString(table, "providerRefreshToken")
	a.ProviderAccessToken = field.NewString(table, "providerAccessToken")
	a.ProviderScope = field.NewString(table, "providerScope")
	a.LoggedIn = field.NewTime(table, "loggedIn")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["providerRefreshToken"] = a.ProviderRefreshToken
	a.fieldMap["providerAccessToken"] = a.ProviderAccessToken
	a.fieldMap["providerScope"] = a.ProviderScope
	a.fieldMap["loggedIn"] = a.LoggedIn
}
