...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.DisplayName = field.NewString(tableName, "displayName")
	_user.Email = field.NewString(tableName, "email")
	_user.PhotoURL = field.NewString(tableName, "photoURL")
	_user.IsAdmin = field.NewBool(tableName, "isAdmin")
	_user.RefreshToken = field.NewString(tableName, "refreshToken")
...
func (u *user) updateTableName(table string) *user {
	...
	u.DisplayName = field.NewString(table, "displayName")
	u.Email = field.NewString(table, "email")
	u.PhotoURL = field.NewString(table, "photoURL")
	u.IsAdmin = field.NewBool(table, "isAdmin")
	u.RefreshToken = field.NewString(table, "refreshToken")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["photoURL"] = u.PhotoURL
	u.fieldMap["isAdmin"] = u.IsAdmin
	u.fieldMap["refreshToken"] = u.RefreshToken
